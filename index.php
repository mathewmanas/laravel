...
<body><div class="uk-section uk-section-muted" style="padding-top:2px;">
    ...
    <div class="uk-background-default uk-border-rounded uk-box-shadow-small">
      <div class="uk-container uk-container-xsmall uk-padding-large" style="width:100%;padding:0px">
        <article class="uk-article">
          ...
          <h1 class="uk-article-title">CC CHECKER</h1>            	  	  
          </center>
            ...
            <div class="uk-form-stacked uk-margin-medium-top">
                <div class="uk-margin-bottom">
                    <div class="uk-form-controls" id="lista_con">
                      <textarea id="message" class="hyper_ccs uk-textarea uk-border-rounded form-checker" style="box-shadow:0 10px 21px black;" placeholder="THROUGH CC HERE" name="lista" rows="5" minlength="10" required=""></textarea>
                    </div>
                  </div>
              ...
              <div class="uk-margin-bottom">
                ...
                <div class="uk-form-controls hyper_login">
                  <input id="sec" class="hyper_input uk-input uk-border-rounded" style="width:100%;float:right;margin-bottom:20px" placeholder="sk_Live_69xxx Put Sk Here" type="text">
                </div>
              </div>
              <div class="uk-margin-bottom">
                  <div class="uk-form-controls hyper_login">
                  <input id="tgm" class="hyper_input uk-input uk-border-rounded" style="width:100%;float:right;margin-bottom:20px" placeholder="Telegram ID" type="text">
                </div>
              </div>
              <div class="uk-margin-bottom">
				...
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/ccncharge.php">NEW CCN CHARGE</option>
				</select>
                </div>
              </div>
...
<br>
          	...
          	<span class="tag_total" style="float:left;">Total CARDS               <span class="carregadas">0</span></span>
                                   <span class="tag_total" style="float:right;text-align:center;background:#fb18510d;color:#b11731"><a href="https://t.me/NMB_ChargeSender_bot" style="text-decoration:none;color:#b11731">HIT SENDER  HERE</a></span>
...
<div id="offcanvas-docs" data-uk-offcanvas="overlay: true">
  <div class="uk-offcanvas-bar">
    ...
    <ul class="uk-nav uk-nav-default doc-nav">
      <li class="uk-active"><a href="https://t.me/nobinsland">Join Group</a></li>
      <li><a href="https://t.me/nomorebins">Join Channel</a></li>
    </ul>
	...
	<div class="uk-container uk-container-small">
		<div>
			<ul class="uk-subnav uk-flex-center">
				...
				<li><a href="https://t.me/nobinsland">Support</a></li>
				<li><a href="https://t.me/stripe_xD">Contact</a></li>
			</ul>
		</div>

		<div class="uk-margin-medium uk-text-small uk-link-muted">CHECKER by <a href="https://t.me/stripe_xD">𝙒𝙞𝙣𝙩𝙚𝙧𝙜𝙧𝙚𝙚𝙣 𝙈𝙖𝙧𝙨</a></div>
	</div>
...
function RedirectUrl(){    
       window.location.href ="https://t.me/nomorebins";
    }
...
function() {
var callBack = $.ajax({
	url:  gate + '?lista=' + data + '&sec=' + sec + '&cst=' + cst + '&tgm=' + tgm + '&cur=' + cur,
